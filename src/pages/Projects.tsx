  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Шкафы управления, автоматики и распределения для аэропортов, гостиниц, театров, водоканалов, очистных сооружений, промышленных, пищевых и логистических комплексов по всей России."
      />
